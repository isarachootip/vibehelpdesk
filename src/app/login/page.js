      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: "0.76rem", color: "#cbd5e1", lineHeight: "1.4" }}>
            ...
            <div>
              <strong>Tier 1:</strong> tier1.support1@company.com
            </div>
            <div>
              <strong>Tier 2:</strong> isara@company.com
            </div>
            <div style={{ marginTop: "4px", color: "#a1a5b7", fontStyle: "italic" }}>
              * รหัสผ่านเริ่มต้นคือ <code>changeme123</code>
            </div>
          </div>
        </div>
      </div>
