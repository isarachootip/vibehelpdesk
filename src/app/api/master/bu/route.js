...
export async function POST(request) {
  try {
    const { bu_code, bu_name, bu_description, contact_person, phone, line_id, website, logo_url } = await request.json();
    ...
    const bu = await prisma.businessUnit.create({
      data: { bu_code, bu_name, bu_description, contact_person, phone, line_id, website, logo_url: logo_url || null },
    });
